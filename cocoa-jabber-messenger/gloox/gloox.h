...
namespace gloox
{
  ...
  /** Attention namespace (Sina-XEP) */
  GLOOX_API extern const std::string XMLNS_VIKA_GROUP;

  /** Attention namespace (Sina-XEP) */
  GLOOX_API extern const std::string XMLNS_VIKA_PRIVACY;

  /** Attention namespace (Sina-XEP) */
  GLOOX_API extern const std::string XMLNS_VIKA_FINDUSER;

  /** Attention namespace (Sina-XEP) */
  GLOOX_API extern const std::string XMLNS_VIKA_LOCATION;

  /** Attention namespace (Sina-XEP) */
  GLOOX_API extern const std::string XMLNS_GATEWAY_ERROR;

  /** Attention namespace (Sina-XEP) */
  GLOOX_API extern const std::string XMLNS_SINA_PRIVATE;
  ...
  enum SaslMechanism
  {
	...
	//SaslMechSINASSO        =  16384, /**< SASL SINASSO (Win32 only). */
...
//   };
  ...
  /**
  * Describes the different valid vika types.
  */
  enum VikaType
  {
	VikaNone,
	VikaGroup,                  /**< The group extension will be used get the group's action. */
	VikaPrivacy,				/**< The privacy extension will be used get the block list. */
	VikaFindUser				/**< The resule of sina search. */

  };

  /**
  * Describe different operation methods in gourps.
  */
  enum VikaGroupOperation
  {
	VikaGroupNone,
	VikaGroupApply,
	VikaGroupInvite,
  ...
  /**
  * Describe different type in location service.
  */
  enum LocationType
  {
	LocationNone,
  ...
  /**
  * Describe different type of gateway.
  */
  enum GatewayType
  {
	GatewayNONE,
