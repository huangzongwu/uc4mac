...
namespace gloox
{
                               ...
                               public IqHandler
  {
    ...
    public:
	  ...
	  /**
	  * Reimplement this function to provide a version for this application.
	  * @return The version.
	  */
	  ...
	  *	It will be used Server's report.
	  * @param version
	  */
      ...
      /**
       * This function gives access to the @c Vika object.
       * @return A pointer to the Vika object.
       */
      virtual Vika* vika() const { return m_vika; }
       ...
       */
      void send( Presence& pres , bool issafe = true );
	  ...
	  bool keepAlive(std::string xmlTag);
      ...
      /**
       * Registers @c sh as object that receives vika-data each time
       * @param vh The VikaHandler to register.
       */
      ...
      /**
       * Removes the current VikaHandler
       */
	  ...
	  /**
	   * Return the xmpp connection's error
	   */
	  std::list<std::string> getClientError();
    ...
    protected:
	  ...
	  Vika* m_vika;						 /**< The vika Service client. */
	  ...
	  std::string m_appversion;			 /**< The version of application . */
	  std::string m_coreversion;		 /**< The version of core . */
