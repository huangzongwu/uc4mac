...
namespace gloox
{
  ...
  enum StanzaExtensionType
  {
    ...
    ExtUser,                         /**< User-supplied extensions must use IDs above this. Do
                                     ...
                                     * to change. */
	ExtVikaGroup,					/**< An extension dealing with Sina vika-group data>**/
	ExtVikaFind,					/**< An extension dealing with Sina vika-find servicee>**/
	ExtVikaPrivacy,					/**< An extension dealing with Sina vika-privacy extension>**/

	ExtGateway,						/**< An extension dealing with Sina gateway extension>**/
	ExtVikaLocation					/**< An extension dealing with location extension>**/
