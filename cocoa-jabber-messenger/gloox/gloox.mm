...
namespace gloox
{
  ...
  const std::string XMLNS_VIKA_GROUP		= "vika:group";
  const std::string XMLNS_VIKA_PRIVACY		= "vika:privacy";
  const std::string XMLNS_VIKA_FINDUSER		= "vika:finduser";
  const std::string XMLNS_VIKA_LOCATION		= "vika:location";
  const std::string XMLNS_GATEWAY_ERROR		= "sina.com.cn:thirdim";
  const std::string XMLNS_SINA_PRIVATE		= "uc:private";  
