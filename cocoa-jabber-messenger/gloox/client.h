...
namespace gloox
{
  ...
  class GLOOX_API Client : public ClientBase
  {
    public:
	  ...
	  /**
	   * Use this function to set the location,that is, to broadcast presence to all
	   * subscribed entities. 
	   * @param location The Location value to set.
	   */
	  void setLocation(const std::string longitude = EmptyString,const std::string latitude = EmptyString);
    ...
    private:
      ...
      class ResourceBind : public StanzaExtension
      {
        ...
        public:
           ...
           */
			ResourceBind( const std::string& resource, bool bind = true,const std::string& version	= EmptyString );
