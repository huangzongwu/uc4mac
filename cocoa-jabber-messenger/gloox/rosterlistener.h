...
namespace gloox
{
  ...
  class GLOOX_API RosterListener
  {
    public:
       ...
       */
	  virtual void handleItemUnsubscribed( const JID& jid ,const std::string& status ) = 0;
      ...
      /**
       * This function is called whenever presence from an third IM 
       * @param Domain The full domain of gateway.
       */
	  virtual void handleGatewayLogin(const std::string& domain ) = 0;
